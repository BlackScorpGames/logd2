...
if ($op==""){
	...
	$saveclose = htmlentities(translate_inline("Save & Close"), ENT_COMPAT, Settings::getsetting("charset", "ISO-8859-1"));
	$savenotclose = htmlentities(translate_inline("Save No Close"), ENT_COMPAT, Settings::getsetting("charset", "ISO-8859-1"));
