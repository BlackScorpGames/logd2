<?php
OutputClass::output("`\$%s`0 waves his skeletal arms as he begins to command the very fabric of life.`n`n",$deathoverlord);
...
OutputClass::output("\"`)Noitcerruser evah llahs ut...`\$\"  The air begins to crackle around you.`n`n");
OutputClass::output("\"`)Tnavres o htaed eht morf esir.`\$\" Your soul begins to burn with the pain of a thousand frosty fires.`n`n");
