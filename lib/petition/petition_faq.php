...
OutputClass::output_notl("&#149;<a href='petition.php?op=primer'>%s</a><br/>", $t, true);
$t = Translator::translate_inline("`@Frequently Asked Questions on Game Play (General)`0");
OutputClass::output_notl("&#149;<a href='petition.php?op=faq1'>%s</a><br/>", $t, true);
$t = Translator::translate_inline("`@Frequently Asked Questions on Game Play (with spoilers)`0");
OutputClass::output_notl("&#149;<a href='petition.php?op=faq2'>%s</a><br/>", $t, true);
$t = Translator::translate_inline("`@Frequently Asked Questions on Technical Issues`0");
OutputClass::output_notl("&#149;<a href='petition.php?op=faq3'>%s</a><br/>", $t, true);
