...
if ($op==""){
	if (!Http::httpget('nointro')) {
		OutputClass::output("`\$Fighting down every urge to flee, you cautiously enter the cave entrance, intent on catching the great green dragon sleeping, so that you might slay it with a minimum of pain.");
		OutputClass::output("Sadly, this is not to be the case, for as you round a corner within the cave you discover the great beast sitting on its haunches on a huge pile of gold, picking its teeth with a rib.");
	}
	$badguy = array(
	...
	$flawless = (int)(Http::httpget('flawless'));
  	if ($flawless) {
		OutputClass::output("`b`c`&~~ Flawless Fight ~~`0`c`b`n`n");
	}
	OutputClass::output("`2Before you, the great dragon lies immobile, its heavy breathing like acid to your lungs.");
	OutputClass::output("You are covered, head to toe, with the foul creature's thick black blood.");
	OutputClass::output("The great beast begins to move its mouth.  You spring back, angry at yourself for having been fooled by its ploy of death, and watch for its huge tail to come sweeping your way.");
	OutputClass::output("But it does not.");
	OutputClass::output("Instead the dragon begins to speak.`n`n");
	OutputClass::output("\"`^Why have you come here mortal?  What have I done to you?`2\" it says with obvious effort.");
	OutputClass::output("\"`^Always my kind are sought out to be destroyed.  Why?  Because of stories from distant lands that tell of dragons preying on the weak?  I tell you that these stories come only from misunderstanding of us, and not because we devour your children.`2\"");
	OutputClass::output("The beast pauses, breathing heavily before continuing, \"`^I will tell you a secret.  Behind me now are my eggs.  They will hatch, and the young will battle each other.  Only one will survive, but she will be the strongest.  She will quickly grow, and be as powerful as me.`2\"");
	OutputClass::output("Breath comes shorter and shallower for the great beast.`n`n");
	OutputClass::output("\"`#Why do you tell me this?  Don't you know that I will destroy your eggs?`2\" you ask.`n`n");
	OutputClass::output("\"`^No, you will not, for I know of one more secret that you do not.`2\"`n`n");
	OutputClass::output("\"`#Pray tell oh mighty beast!`2\"`n`n");
	OutputClass::output("The great beast pauses, gathering the last of its energy.  \"`^Your kind cannot tolerate the blood of my kind.  Even if you survive, you will be a feeble creature, barely able to hold a weapon, your mind blank of all that you have learned.  No, you are no threat to my children, for you are already dead!`2\"`n`n");
	OutputClass::output("Realizing that already the edges of your vision are a little dim, you flee from the cave, bound to reach the healer's hut before it is too late.");
	OutputClass::output("Somewhere along the way you lose your weapon, and finally you trip on a stone in a shallow stream, sight now limited to only a small circle that seems to float around your head.");
	OutputClass::output("As you lay, staring up through the trees, you think that nearby you can hear the sounds of the village.");
	OutputClass::output("Your final thought is that although you defeated the dragon, you reflect on the irony that it defeated you.`n`n");
	OutputClass::output("As your vision winks out, far away in the dragon's lair, an egg shuffles to its side, and a small crack appears in its thick leathery skin.");
	...
	OutputClass::output("`n`nYou wake up in the midst of some trees.  Nearby you hear the sounds of a village.");
